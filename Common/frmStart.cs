...
namespace Modbus
{
	public class frmStart : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
            ...
            this.grpData.Size = new System.Drawing.Size(834, 267);
            ...
            this.grpStart.Size = new System.Drawing.Size(834, 55);
            ...
            this.grpExchange.Controls.Add(this.accelerationTextBox);
            this.grpExchange.Controls.Add(this.velocityTextBox);
            this.grpExchange.Controls.Add(this.goButton);
            ...
            this.grpExchange.Size = new System.Drawing.Size(834, 118);
            ...
            this.label6.Location = new System.Drawing.Point(666, 48);
            ...
            // accelerationTextBox
            // 
            this.accelerationTextBox.Location = new System.Drawing.Point(734, 45);
            this.accelerationTextBox.Name = "accelerationTextBox";
            this.accelerationTextBox.Size = new System.Drawing.Size(100, 20);
            this.accelerationTextBox.TabIndex = 28;
            // 
            // velocityTextBox
            // 
            this.velocityTextBox.Location = new System.Drawing.Point(734, 19);
            this.velocityTextBox.Name = "velocityTextBox";
            this.velocityTextBox.Size = new System.Drawing.Size(100, 20);
            this.velocityTextBox.TabIndex = 27;
            this.velocityTextBox.TextChanged += new System.EventHandler(this.textBox1_TextChanged);
            // 
            // goButton
            // 
            this.goButton.Location = new System.Drawing.Point(716, 83);
		...
		private void btnWriteMultipleReg_Click(object sender, System.EventArgs e)
		{
            ...
            //Debug.WriteLine(result[4] + "" + result[5]);
            //Debug.WriteLine(result[12] + "" + result[13] + "" + result[14] + "" + result[15]);
		...
		private byte[] GetData(int size)
		{
			...
			if(radBits.Checked)
			{
				int numBytes		= (byte)(size / 8 + (size % 8 > 0 ? 1 : 0));
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            int acceleration = Convert.ToInt16(accelerationTextBox.Text);
           
            setPointVelocity.GetSetValue = Convert.ToInt16(velocityTextBox.Text);
        ...
        public void ModifyBit(byte data, int pos)
        {
            Console.WriteLine(data);
            BitArray bits = new BitArray(data);
            bits[pos] = (bits[pos].Equals(0) ? bits[pos] = true : bits[pos] = false);
            data = Convert.ToByte(bits);
            Console.WriteLine(data);
        }
        ...
        {
            ControlWord_I3 test = new ControlWord_I3();
            if (test.EnableStop)
                test.EnableStop = false;
            else
                test.EnableStop = true;
            Console.WriteLine(test.EnableStop);
        }
